...
namespace Rewired.Demos.CustomPlatform {
    ...
    public class UnityInputJoystickSource {
        ...
        public class Joystick : Rewired.Interfaces.IControllerVibrator {
            ...
            /// assigned a long id and stored for later lookup, then that id _value could be stored here.
            /// </summary>
            public readonly long systemId;
            public readonly string deviceName;
            /// <summary>
            /// Persistent unique identifier.
            /// This is an optional _value that is for uniquely identifying controllers persistently
            /// across application sessions and system reboots. This _value may not be available on
            /// all platforms or input sources. If this _value cannot be obtained or created in some
