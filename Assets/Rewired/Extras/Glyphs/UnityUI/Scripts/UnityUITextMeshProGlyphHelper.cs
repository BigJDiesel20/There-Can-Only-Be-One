...
namespace Rewired.Glyphs.UnityUI {
    ...
    public class UnityUITextMeshProGlyphHelper : UnityEngine.MonoBehaviour {
        ...
        [UnityEngine.Tooltip("If enabled, local values such as Sprite color will be used instead of the _value on the base material.")]
        [UnityEngine.SerializeField]
        ...
        /// <summary>
        /// If enabled, local values such as Sprite color will be used instead of the _value on the base material.
        /// </summary>
        ...
        protected virtual void Update() {
            ...
            // Handle inspector _value changes
        ...
        /// <summary>
        /// Updates glyphs / text and TMPro text _value immedately.
                ...
                for (int i = startIndex; i < startIndex + count; i++) {
                    ...
                    switch (state) {
                        ...
                        case state_parsingValue:
                            {
                                if ((isQuotedValue && c == doubleQuote) || (!isQuotedValue && (i == lastIndex || char.IsWhiteSpace(c)))) { // end of _value
                                    // Append _value on last index for non-quoted values, otherwise it will fail if no space before closing tag
                                    if (!isQuotedValue && i == lastIndex) sbValue.Append(c);
                                    if (sbValue.Length == 0) throw new Exception("Value was blank."); // no _value
        ...
        public struct TMProSpriteOptions : IEquatable<TMProSpriteOptions> {
            ...
            [UnityEngine.Tooltip("This _value will be multiplied by the Sprite width and height and applied to offset.")]
            [UnityEngine.SerializeField]
            ...
            [UnityEngine.Tooltip("This _value will be multiplied by the Sprite width applied to X Advance.")]
            [UnityEngine.SerializeField]
            ...
            /// <summary>
            /// Sprites will be scaled by this _value.
            /// </summary>
            public float scale {
                get {
                    return _scale;
            ...
            /// <summary>
            /// This _value will be multiplied by the Sprite width and height and applied to offset.
            /// </summary>
            ...
            /// <summary>
            /// This _value will be multiplied by the Sprite width applied to X Advance.
            /// </summary>
